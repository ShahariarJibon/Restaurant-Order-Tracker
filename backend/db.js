  ...
  if (process.env.DATABASE_URL) {
    ...
    await pgPool.query(`
      CREATE TABLE IF NOT EXISTS restaurants (
        ...
        password TEXT NOT NULL, created_at TIMESTAMP DEFAULT NOW()
      )
    `);
    await pgPool.query(`
    ...
    db.run(`CREATE TABLE IF NOT EXISTS restaurants (id TEXT PRIMARY KEY, name TEXT NOT NULL, email TEXT UNIQUE NOT NULL, password TEXT NOT NULL, created_at TEXT DEFAULT (datetime('now')))`);
